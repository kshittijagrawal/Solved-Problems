[Discussion Post (created on 27/9/2021 at 23:40)](https://leetcode.com/problems/maximum-difference-between-increasing-elements/discuss/1544123/Python3-O(n)-Time-or-O(1)-Space.)  
